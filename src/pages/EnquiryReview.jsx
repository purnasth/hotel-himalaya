  ...
  return (
    <>
      <main>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 md:mt-32">
          <div className="col-span-1 sticky top-20 overflow-y-auto max-h-screen order-2 lg:order-1">
